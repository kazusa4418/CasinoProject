...
public class Save {
    ...
    public static File createNewFile() {
        ...
        while (flag) {
            ...
            for (int i = 0; i < arrayFiles.length; i++) {
                String file = arrayFiles[i].toString();
    ...
    public static int showFiles() {
        ...
        for (int i = 0; i < saveFiles.length; i++) {
            String name = saveFiles[i].toString().replace("saves\\", "").replace(".dat", "");
            fileNames.add(name);
        }
        int i = 0;
    ...
    public static File getFile(String fileName) {
        ...
        File saveFile = matchSaveFile(fileName);
        return saveFile;
    }

    public static PlayData readSaveFile(File file, PlayData readData) {
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(file));) {
            readData = (PlayData) ois.readObject();
            return readData;
        } catch (IOException e) {
    ...
    public static void writeFile(File file, PlayData writeData) {
